...
class ProduitControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'produit[descp]' => 'Testing',
            'produit[catg]' => 'Testing',
            'produit[prix]' => 'Testing',
            'produit[image]' => 'Testing',
            'produit[commande]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'produit[descp]' => 'Something New',
            'produit[catg]' => 'Something New',
            'produit[prix]' => 'Something New',
            'produit[image]' => 'Something New',
            'produit[commande]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getCatg());
