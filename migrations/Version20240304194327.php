 ...
 */
final class Version20240304194327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dechets (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, date_entre DATE NOT NULL, quantité DOUBLE PRECISION NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_rec DATE NOT NULL, INDEX IDX_CE606404A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, reclamation_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, date_rep DATE NOT NULL, INDEX IDX_5FB6DEC72D6BA2D9 (reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation_dechets (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, dechets_id INT DEFAULT NULL, quantité DOUBLE PRECISION NOT NULL, date DATE NOT NULL, date_ramassage DATE NOT NULL, nom_fournisseur VARCHAR(255) NOT NULL, numero_tell INT NOT NULL, INDEX IDX_317AD52AA76ED395 (user_id), INDEX IDX_317AD52A7FAE66FB (dechets_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
